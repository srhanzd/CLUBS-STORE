            ...
            /*Order Details Ends Here*/
                 ...
                 $id=$Order->id;
    	                ...
    	                <p>Thank you for your order. We’ll send a confirmation when your order ships.
    	                 Your estimated delivery date is 3-5 working days. If you would like to view the status of
    	                 your order or make any changes to it, please visit Your Orders on
    	                  <a href="https://www.CLUBS_STORE.com">CLUBS_STORE.com</a></p>
    	               ...
    	               '.$Delivery_Address.'</p>
    	                ...
    	                $emailcontent=array(
    	                    ...
    	                    ($loginid, $name,$id)
    	                    {
    	                        ...
    	                        ('Your CLUBS_STORE.com order '.$id.' is Confirmed');
