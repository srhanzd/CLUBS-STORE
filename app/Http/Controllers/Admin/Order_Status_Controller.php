        ...
        /* Email Alert Starts Here*/
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailbody='<p>Your Order has been Shipped. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.CLUBS_STORE.com">CLUBS_STORE.com</a></p><br>
        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$id)
        	                    {
        	                        ...
        	                        (' Your CLUBS_STORE.com order '.$id.' is Shipped');
        	                        $message->from('CLUBS_STORE@gmail.com','CLUBS_STORE');
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    {
        	                        $message->to($loginid, $name)->subject
        	                        ('Your CLUBS_STORE.com order '.$id.' is Delivered');
        	                        $message->from('CLUBS_STORE@gmail.com','CLUBS_STORE');
        ...
        $Orders->update();
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                As per Your Request, we have cancelled your Order. If you paid any payment with us
        	                , it will be refunded within 2-3 Working Days...</p>
        	                <h4>Order Details: </h4><p> Order No:'.$id.$Order_Details.'</p>
        	                 <p><strong>Delivery Address:</strong>
        	               '.$Delivery_Address.'</p>
        	                <p> <strong>Total Amount:</strong>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    {
        	                        $message->to($loginid, $name)->subject
        	                        ('Your CLUBS_STORE.com order '.$id.' is Cancelled');
        	                        $message->from('CLUBS_STORE@gmail.com','CLUBS_STORE');
