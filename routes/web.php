...
Route::get('/type-product/{id}', 'TypeController@type_product')->name('type-product');
...
Route::get('/Shop/{id}', 'Product_Ordering_Controller\FrontEndController@index');
...
Route::get('/Order-print/{id}', 'Order_Status_Controller@Order_print')->middleware('auth');
Route::post('/print/{id}', 'Order_Status_Controller@print')->name('print')->middleware('auth');
