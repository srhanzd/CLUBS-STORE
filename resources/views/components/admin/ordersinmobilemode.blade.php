    ...
    <div class="row d-flex justify-content-center" style="margin-top:-30px;">
                        ...
                        @foreach ($Orders as $item)
                          ...
                          <p align="left"><strong style="color:yellow;">Amount: </strong> {{$item->Amount}} INR<br>
                                    <p align="left"><strong style="color:yellow;">print:

                                        @if($item->print!=null)
                                        </strong> {{$item->print}} <br>
                                        @else
                                        </strong> Not Requested<br>
                                        @endif
                          <strong style="color:yellow;">Delivery Info: </strong> <br><?php echo $item->Delivery_Address ?></p>
