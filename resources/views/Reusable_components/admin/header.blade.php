        ...
        <div class="container d-flex" >
          ...
          <nav class="nav-menu d-none d-lg-block contentfont"style="margin-top: 10px;"  >
            <ul style="margin-top:5px">
              ...
              <li class="active"><a href="/#Startups">Products</a></li>
                ...
                @auth
                  <li class="drop-down active"><a href="#">Dashboard <i class="fas fa-angle-down"></i></a>
                       <ul>
             ...
             <li><a href="/#Startups" style="margin-left:15px;">   <i class="fas  fa-2x"><img src="{{url('assets/img/buy.gif')}}"style="width: 30px;"></i></a></li>
